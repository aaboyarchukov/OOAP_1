...
Проанализировав эталонное решение, я пришел к выводам о том, что мое решение оказалось верным за исключением названия методов.
Радует, что с каждым новыми заданием я совершаю меньше количество ошибок!